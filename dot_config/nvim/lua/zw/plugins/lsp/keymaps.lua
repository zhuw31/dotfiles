...
function M.on_attach(client, buffer)
  ...
  self:map("gk", "Telescope lsp_type_definitions", { desc = "Goto Type Definition" })
  ...
  local format = require("zw.plugins.lsp.format").format
  self:map("gm", format, { desc = "Format Document", has = "documentFormatting" })
  self:map("gm", format, { desc = "Format Range", mode = "v", has = "documentRangeFormatting" })
  self:map("gn", M.rename, { expr = true, desc = "Rename", has = "rename" })
end
